...
With this dashboard, you can easily investigate current projects and identified research needsin the Rosa database, considering various factors such as location, needs type, and more..
...
list(
  color = "#016FB1",
  value = length(unique(data_current_pro$location_mg))
)
```
